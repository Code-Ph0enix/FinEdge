...
//   .filter(stock => stock.currentPrice && stock.monthlyInvestment) // ✅ ADD THIS FILTER
//   .map((stock, index) => (
//     <div
//       key={index}
...
//       {/* Investment Allocation - ✅ SAFE VERSION */}
              ...
              {recommendations.stocks
                ...
                .map((stock, index) => (
                  ...
                  >
                    ...
                    {/* ✅ FIXED: Price & Returns - Proper dark mode contrast */}
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Current Price</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">
                    ...
                    {/* ✅ FIXED: Investment Allocation - Better dark mode */}
                    ...
                    {/* ✅ FIXED: Key Metrics - Better dark mode */}
                    {stock.keyMetrics && (
                      <div className="grid grid-cols-3 gap-2 mb-4">
                        {stock.keyMetrics.pe && (
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendations.mutualFunds
                ...
                >
                  ...
                  {/* ✅ FIXED: Returns - Better dark mode */}
                  <div className="grid grid-cols-3 gap-2 mb-4">
                    <div className="text-center p-2 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <p className="text-xs text-gray-500 dark:text-gray-400">1Y</p>
                      <p className="text-sm font-semibold text-green-600 dark:text-green-400">{fund.returns1Y}%</p>
                  ...
                  {/* ✅ FIXED: Allocation - Better dark mode */}
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500 dark:text-gray-400">Monthly Amount</span>
                      <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">₹{fund.monthlyInvestment.toLocaleString('en-IN')}</span>
                    </div>
                  </div>
              ...
              {recommendations.fixedDeposits.map((fd, index) => (
                ...
                >
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500 dark:text-gray-400">Monthly Deposit</span>
                      <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">₹{fd.monthlyInvestment.toLocaleString('en-IN')}</span>
                    </div>
                  </div>
