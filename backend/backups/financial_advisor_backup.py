...
# ===============================================================================================================================
# LATEST VERSION BUT STILL KEPT IN BACKUP CODE FILE BECAUSE OF ITS IMPORTANCE AND WILL BE REPLACED BY ANOTHER NEWER VERSION.
# ===============================================================================================================================
        ...
        for idx, api_key in enumerate(GROQ_API_KEYS, 1):
            if api_key:
                try:
                    ...
                    llm = ChatGroq(
                        model=model_override or "your-ai-model-here",  # your ai model here
...
try:
    ...
    groq_chat_llm = initialize_llm_with_fallback(temperature=1, max_tokens=2048, model_override="llama-3.3-70b-versatile")
...
try:
    ...
    react_llm = initialize_llm_with_fallback(temperature=0, max_tokens=1024,model_override="llama-3.1-8b-instant")
...
{{
    ...
    "reasoning": "brief 1-line explanation"
        ...
        # Quick classification using active LLM
        classifier_llm = initialize_llm_with_fallback(temperature=0, max_tokens=100,model_override="llama-3.1-8b-instant")
...
# ===============================================================================================================================
# SLIGHTLY MODIFIED VERSION BUT STILL KEPT IN BACKUP CODE FILE BECAUSE OF ITS IMPORTANCE AND WILL BE REPLACED BY A NEWER VERSION.
# ===============================================================================================================================
...
# ==============================================================================================================
# THE FIRST AND OLDEST VERSION OF ALL TIME 
# ==============================================================================================================
